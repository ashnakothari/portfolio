...
var PageName = 'manage 3';
var PageId = 'p469e1f731b364d85bedb3137c605bfc0'
var PageUrl = 'manage_3.html'
document.title = 'manage 3';
...
if (true) {
    ...
    var reload = ParentWindowNeedsReload("album_cover_change.html");
	top.opener.window.location.href = "album_cover_change.html" + GetQuerystring();
    if (reload) {
